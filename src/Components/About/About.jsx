    ...
    return (
        <>
                ...
                <div className="container">
                    <div className={style.content__card}>
                        <div className={style.content__cards}>
                            ...
                            <FirstButton>Узнать больше</FirstButton>
                        </div>
            ...
            <section className={style.cards}>
                ...
                <LastButton>все услуги</LastButton>
                </div>
                <div className={style.cards__content}>
                    ...
                    <img  src="https://preview.redd.it/z2bc71alfso61.png?width=640&crop=smart&auto=webp&s=168e45a8179309beb57db4449f0e150edf11cd44" alt="" height='315px' width='100%' />
                    </div>
